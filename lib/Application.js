...
var Application = subclass(function (pt) {
    ...
    pt.execute = function (cliOptions, cmdOptions) {
        ...
        return this.lint(cmdOptions.ignore, cmdOptions.eslintOptions)

    }

    pt.help = function () {

        console.log(multiline.stripInden(function () { /*
            Usage:
                %s <flags> [FILES...]
    ...
    pt.version = function () {
        ...
        console.log(this.this.cmdName + ' ' + this.options.version)

        return 0

    }

    pt.lint = function (ignore, eslintOptions) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            deglob(JS_PATTERNS, deglobOpts, function (err, files) {
                ...
                try {
                    ...
                    result = new eslint.CLIEngine(eslintOptions).executeOnFiles(files)
